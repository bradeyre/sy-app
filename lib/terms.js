...
export function renderTermsHtml(site) {
  ...
  const consignment = [
    ...
    clause(
      ...
      sub("5.3 Device Inspection:", "By submitting your device (excluding brand-new or factory-sealed units), you consent to our trusted technicians opening the device where needed to inspect for internal issues, including liquid damage. If your device is damaged during this inspection, Epic Deals will cover the cost of repair.")
    ),
    clause(
