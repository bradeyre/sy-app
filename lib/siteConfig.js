...
function shape(row) {
  // category_filter order is the cockpit default. Watch + Luxury Watch are
  // pinned as a pair (Watch first) so a later Luxury Watch row cannot land
  // at the bottom of the sell-form list.
