...
//
// Final leads of the Aug 2026 recovery. Both reached Airtable only via the cron
// bridge, which wrote them repeatedly, with the wrong quoted value, no brand and
// no attachments. Those records are now deleted, so this replays the stored lead
// and stored items through the normal syncLeadToAirtable path.
//
...
const RECOVERABLE = new Set([67, 69]);
