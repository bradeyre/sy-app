...
Je=Qe==="Mint",[Ze,Xe]=m(!1);return A&&z?<div className="space-y-2">
      ...
      {Je&&<div className="mb-3">
        ...
        <p className="px-1 pt-2 text-xs text-muted">
          Excellent is for a nearly new device. Most used phones are Good, so if yours has any wear at all, please go back and choose Good, it is still a strong price.
        </p>
      </div>}
      <p className="mb-2 text-sm font-medium text-muted">
