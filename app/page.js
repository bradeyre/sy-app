    ...
    <button type="button"onClick={l}className="w-full rounded-xl bg-brand px-4 py-3.5 font-semibold text-white transition hover:bg-brand-600">
      ...
      <div className="rounded-lg border border-line bg-canvas p-3">
        ...
        <div className="mt-3">
          ...
          <input type="file"accept="image/*,.heic,.pdf,application/pdf"required={u.status!=="done"}onChange={c=>r(c.target.files?.[0])}className="block w-full text-base text-muted file:mr-3 file:rounded-lg file:border-0 file:bg-brand file:px-3 file:py-2 file:text-base file:font-semibold file:text-white hover:file:brightness-95"/>
        ...
        <div className="mt-3">
          ...
          <input type="file"accept="image/*,.heic"capture="user"required={b.status!=="done"}onChange={c=>A(c.target.files?.[0])}className="block w-full text-base text-muted file:mr-3 file:rounded-lg file:border-0 file:bg-brand file:px-3 file:py-2 file:text-base file:font-semibold file:text-white hover:file:brightness-95"/>
