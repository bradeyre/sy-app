...
Je=Qe==="Mint",[Ze,Xe]=m(!1);return A&&z?<div className="space-y-2">
        ...
        <button type="button"onClick={()=>{x.length>0||p?T(!1):r()}}className="mt-4 w-full rounded-xl bg-brand px-4 py-3.5 font-semibold text-white shadow-sm transition hover:brightness-95 hover:shadow-[0_0_20px_color-mix(in srgb, var(--brand) 35%, transparent)]">
          Continue
        </button>
      ...
      {Je&&<div className="mb-3">
        ...
        <p className="px-1 pt-2 text-xs text-muted">
          Excellent is for a nearly new device. Most used phones are Good, so if yours has any wear at all, go back and choose Good, it is still a strong price.
        </p>
      </div>}
      <p className="mb-2 text-sm font-medium text-muted">
      ...
      {g?<p className="rounded-lg bg-red-500/10 px-4 py-3 text-sm text-red-500">
        ...
        </p>:<p className="px-1 pt-1 text-xs text-muted">
      ...
      <button type="button"disabled={!!g||Je&&!Ze}onClick={r}className="mt-4 w-full rounded-xl bg-brand px-4 py-3.5 font-semibold text-white shadow-sm transition hover:brightness-95 hover:shadow-[0_0_20px_color-mix(in srgb, var(--brand) 35%, transparent)] disabled:opacity-60 disabled:hover:shadow-none">
        Continue
      </button>
